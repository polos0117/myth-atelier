...
The search script lives inside this skill's own directory. This copy is checked into the repository at `.claude/skills/ui-ux-pro-max/` — run it from the repository root (`/home/user/myth-atelier` in cloud sessions):

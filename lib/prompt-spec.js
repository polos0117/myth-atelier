...
(function (root) {
  ...
  var STYLES = [
    ['game_keyart', '게임 키아트 2.5D', 'Polished 2.5D game key art: clean linework and controlled anime facial design over dense, deeply rendered shading with strong contrast and dark weighted shadows. Dramatic rim and key light against a darker environment, crisp costume and ornament detail, vivid readable silhouette, campaign-poster impact. Avoid soft pastel palettes, flat or washed-out shading and light watercolor delicacy.'],

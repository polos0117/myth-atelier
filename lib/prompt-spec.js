...
(function (root) {
  ...
  var EXTRAS = [
    ...
    ['myth', '신화권 옷·재질 언어', '북유럽 모피·룬, 그리스 청동·월계, 한국 단청·노리개, 중국 비단·옥, 일본 오비·금줄, 인도 금·연꽃, 이집트 아마포·청금석']
  ];
  ...
  var PARAMS = [
    { key: "ethnicity", ko: "얼굴 계통", label: "Facial ethnicity", group: "base", auto: {"norse": "Nordic", "greek": "Mediterranean", "korea": "Korean", "china": "Chinese", "japan": "Japanese", "india": "South Asian", "egypt": "North African and Egyptian", "celtic": "Irish and Celtic British"},

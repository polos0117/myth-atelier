...
(function (root) {
  ...
  var WORDS = {
    ...
    'home.run.title': '던전',
    'home.run.note': '무기 셋을 데려가 여덟 칸의 길을 간다. 각성은 카드를 쌓아 열고, 저주는 감수한다.',
    ...
    /* 던전 */
    'run.title': '던전',
    'run.subtitle': '무기 셋을 데려가 여덟 칸의 길을 간다. 각성은 쌓아서 열고, 저주는 감수한다.',
    ...
    'run.node.fight': '싸움', 'run.node.boss': '보스', 'run.node.shrine': '제단', 'run.node.gate': '저주의 문', 'run.node.rest': '휴식',
    'run.map.title': '길',
    'run.map.note': '여덟 칸. 싸움 넷, 제단·저주의 문·휴식, 끝에 보스.',
    'run.map.go': '나아간다',
    'run.party': '동료',
    'run.enemy': '상대',
    'run.hp': '{hp} / {max}',

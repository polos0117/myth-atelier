...
const CREST_MARK = {
  ...
  stone: [
    ['M10 42V17l5-4 5 4v25M28 42V15l5-4 5 4v27','line'],
    ['M8 13h32','line'],
    ['M24 30a3 3 0 1 1 3 3M24 30a3 3 0 1 0-3 3M24 30v-4','signal'],
    ['M6 44h36','line'],
    ['M37 6a1.8 1.8 0 1 0 .1 0Z','paint']
  ],
  dancheong: [
    ['M5 17q19-11 38 0','line'],
    ['M9 17h30M12 21h24','line'],
    ['M16 21v19M32 21v19','line'],
    ['M13 40h6M29 40h6M8 44h32','line'],
    ['M24 26a4 4 0 1 1 0 8a4 4 0 1 1 0-8Z','signal'],
    ['M38 7a2 2 0 1 0 .1 0Z','paint']
  ],
  nile: [
    ['M8 40 24 12l16 28Z','line'],
    ['M4 44h40','line'],
    ['M6 34q9-4 18 0t18 0','signal'],
    ['M24 6a3 3 0 1 0 .1 0Z','paint'],
    ['M15 9q9-6 18 0','line']
  ],
  lapis: [
    ['M6 42h36M10 42V32h28v10M14 32V23h20v9M18 23v-8h12v8','line'],
    ['M22 42v-6h4v6','primary'],
    ['M24 5l1.6 3.4 3.6.4-2.7 2.5.8 3.6-3.3-1.9-3.3 1.9.8-3.6-2.7-2.5 3.6-.4Z','paint'],
    ['M14 27h20','signal']
  ],
  pantheon: [
